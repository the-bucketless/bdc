...
<ul>
  ...
  <li>In the neutral zone, I think the faster pans are giving the MOT some difficulty which is probably resulting in my removing more tracks than I ought to there. As a result, that's where there are most likely to be missing players.</li>
